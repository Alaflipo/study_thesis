# Consent Form: "Interaction methods with metro map editors"

## 1.   Introduction
Eindhoven University of Technology (TU/e) invites you to take part in this research project which aim is to evaluate and improve the algorithmically-assisted metro map editor MOOEY.
...
## 4.   Stopping your participation 
 If you end your participation in the research, we will not use your data anymore from that moment on.  
 If you have any questions or complaints, or if you want to end your participation, please contact the researcher via the contact details in section 2 above.  
 
## 5.   Confidentiality of your participation  
 The consent form, which states your name and signature, will be retained for a period of 10 years. This is needed to be able to prove the integrity of the research - and the data involved in the research. After expiration of this time period the consent form is no longer necessary and will be deleted by the researcher. The consent form will not be accessible to anyone except for the researchers. The consent form will never be linked to any data that is being collected during the research, but will be kept separate at all times. 
